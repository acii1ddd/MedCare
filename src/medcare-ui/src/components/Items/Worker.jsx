export default function Worker({ worker, onClick }) {
    
    const daysOfWeek = ['Воскресенье', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота'];

    return (
        <div className="worker-card border border-gray-300 bg-white p-6 rounded-2xl shadow-lg max-w-md mx-auto transition hover:shadow-xl">
            <div className="worker-image mb-6 w-full h-64 overflow-hidden rounded-lg border">
            ...
            <div className="worker-info text-left space-y-3 text-gray-800">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    ...
                    <p><span className="font-semibold">Роль:</span> {worker.role}</p>
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-gray-500 text-sm">{worker.branch.fullAddress}</p>
                    </div>
                </div>
